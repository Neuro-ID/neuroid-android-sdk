...
class NIDIdentityAllViewsTest {
    ...
    fun identifyAllViews_edit_text() {
        ...
        verify {logger.d("NID test output", "etn: INPUT, et: EditText, eid: edit text 1, v:S~C~~23")}
    }
    ...
    fun identifyAllViews_ToggleButton() {
        ...
        every {dataStoreManager.saveEvent(any())} just runs
        identifyView(view,"someguid", logger, dataStoreManager)
        verify {logger.d("NID test output", "etn: INPUT, et: ToggleButton, eid: toggle button 1, v:S~C~~0")}
    }
    ...
    fun identifyAllViews_SwitchCompat() {
        ...
        every {dataStoreManager.saveEvent(any())} just runs
        identifyView(view,"someguid", logger, dataStoreManager)
        verify {logger.d("NID test output", "etn: INPUT, et: SwitchCompat, eid: switch compat, v:S~C~~0")}
    }
    ...
    fun identifyAllViews_ImageButton() {
        ...
        every {dataStoreManager.saveEvent(any())} just runs
        identifyView(view,"someguid", logger, dataStoreManager)
        verify {logger.d("NID test output", "etn: INPUT, et: ImageButton, eid: image button, v:S~C~~0")}
    }
    ...
    fun identifyAllViews_RatingBar() {
        ...
        every {dataStoreManager.saveEvent(any())} just runs
        identifyView(view,"someguid", logger, dataStoreManager)
        verify {logger.d("NID test output", "etn: INPUT, et: RatingBar, eid: rating bar, v:S~C~~0")}
    }
    ...
    fun identifyAllViews_radio_button_group() {
        ...
        verify(exactly = 2) {logger.d("NID test output", "etn: INPUT, et: RadioButton, eid: RadioButton, v:true")}
    }
