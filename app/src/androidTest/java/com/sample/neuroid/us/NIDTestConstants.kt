...
const val NID_STRUCT_REGISTER_TARGET = "\\{\"type\":\"REGISTER_TARGET\",\"tg\":\\{\"attr\":\\[\\{\"guid\":\"(.*?)\"\\}\\]\\},\"tgs\":\"(.*?)\",\"v\":\"S~C~~\\d{1,}\",\"en\":\"(.*?)\",\"et\":\"(.*?)\",\"eid\":\"(.*?)\",\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
...
const val NID_STRUCT_TEXT_CHANGE = "\\{\"type\":\"TEXT_CHANGE\",\"tg\":\\{\"tgs\":\"(.*?)\",\"attr\":\\[\\{\"n\":\"(.*?)\",\"v\":\"S~C~~\\d{1,}\"\\},\\{\"n\":\"(.*?)\",\"v\":\"(.*?)\"\\}\\],\"etn\":\"(.*?)\",\"et\":\"(.*?)\"\\},\"v\":\"S~C~~\\d{1,}\",\"ts\":\\d{13,},\"sm\":\"(.*?)\",\"pd\":\"(.*?)\"\\}"
