...
const val NID_STRUCT_TOUCH_START = "\\{\"type\":\"TOUCH_START\",\"tg\":\\{\"tgs\":\"(.*?)\",\"sender\":\"(.*?)\",\"etn\":\"(.*?)\"\\},\"ts\":\\d{13,},\"gyro\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\},\"accel\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\}\\}"
const val NID_STRUCT_TOUCH_END = "\\{\"type\":\"TOUCH_END\",\"ts\":\\d{13,},\"x\":(.*?),\"y\":(.*?),\"gyro\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\},\"accel\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\}\\}"
const val NID_STRUCT_TOUCH_MOVE = "\\{\"type\":\"TOUCH_MOVE\",\"ts\":\\d{13,},\"x\":(.*?),\"y\":(.*?),\"gyro\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\},\"accel\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\}\\}"
...
const val NID_STRUCT_INPUT = "\\{\"type\":\"INPUT\",\"tg\":\\{\"tgs\":\"(.*?)\",\"attr\":\\[\\{\"n\":\"(.*?)\",\"v\":\"S~C~~\\d{1,}\"\\},\\{\"n\":\"(.*?)\",\"v\":\"(.*?)\"\\}\\],\"etn\":\"(.*?)\",\"et\":\"(.*?)\"\\},\"ts\":\\d{13,},\"gyro\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\},\"accel\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\}\\}"
const val NID_STRUCT_TEXT_CHANGE = "\\{\"type\":\"TEXT_CHANGE\",\"tg\":\\{\"tgs\":\"(.*?)\",\"attr\":\\[\\{\"n\":\"(.*?)\",\"v\":\"S~C~~\\d{1,}\"\\},\\{\"n\":\"(.*?)\",\"v\":\"(.*?)\"\\}\\],\"etn\":\"(.*?)\",\"et\":\"(.*?)\"\\},\"v\":\"S~C~~\\d{1,}\",\"ts\":\\d{13,},\"gyro\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\},\"accel\":\\{\"x\":(.*?),\"y\":(.*?),\"z\":(.*?)\\}\\}"
