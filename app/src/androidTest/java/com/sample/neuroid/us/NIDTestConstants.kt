...
const val NID_STRUCT_REGISTER_TARGET = "\\{\"type\":\"REGISTER_TARGET\",\"tgs\":\"(.*?)\",\"v\":\"S~C~~\\d{1,}\",\"en\":\"(.*?)\",\"et\":\"(.*?)\",\"eid\":\"(.*?)\",\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
...
const val NID_STRUCT_WINDOW_LOAD = "\\{\"type\":\"WINDOW_LOAD\",\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
const val NID_STRUCT_WINDOW_FOCUS = "\\{\"type\":\"WINDOW_FOCUS\",\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
const val NID_STRUCT_WINDOW_BLUR = "\\{\"type\":\"WINDOW_BLUR\",\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
const val NID_STRUCT_WINDOW_UNLOAD = "\\{\"type\":\"WINDOW_UNLOAD\",\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
const val NID_STRUCT_TOUCH_START = "\\{\"type\":\"TOUCH_START\",\"ts\":\\d{13,},\"x\":(.*?),\"y\":(.*?)\\}"
...
const val NID_STRUCT_FOCUS = "\\{\"type\":\"FOCUS\",\"tg\":\\{\"tgs\":\"(.*?)\",\"etn\":\"INPUT\",\"et\":\"(.*?)\"\\},\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
const val NID_STRUCT_BLUR = "\\{\"type\":\"BLUR\",\"tg\":\\{\"tgs\":\"(.*?)\"\\},\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
const val NID_STRUCT_TEXT_CHANGE = "\\{\"type\":\"TEXT_CHANGE\",\"tg\":\\{\"tgs\":\"(.*?)\",\"etn\":\"(.*?)\",\"et\":\"(.*?)\"\\},\"v\":\"S~C~~\\d{1,}\",\"ts\":\\d{13,},\"url\":\"(.*?)\"\\}"
const val NID_STRUCT_RADIO_CHANGE = "\\{\"type\":\"RADIO_CHANGE\",\"tg\":\\{\"tgs\":\"(.*?)\",\"etn\":\"(.*?)\"\\},\"ts\":\\d{13,},\"x\":(.*?),\"y\":(.*?)\\}"
const val NID_STRUCT_CHECKBOX_CHANGE = "\\{\"type\":\"CHECKBOX_CHANGE\",\"tg\":\\{\"tgs\":\"(.*?)\",\"etn\":\"(.*?)\"\\},\"ts\":\\d{13,},\"x\":(.*?),\"y\":(.*?)\\}"
